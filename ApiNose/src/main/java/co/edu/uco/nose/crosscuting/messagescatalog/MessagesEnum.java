...
public enum MessagesEnum {
	...
	TECHNICAL_ERROR_USER_MAPPER_UNEXPECTED("Se ha presentado un problema inesperado al tratar de ejecutar el proceso de mapeo de datos del usuario. ",
			   "Por favor verifique que la información proveniente de la base de datos sea correcta."),
	USER_ERROR_USER_NOT_FOUND("Se presentó un problema inesperado al consultar la información específica del usuario.",
			"Por favor intente de nuevo y si el problema persiste contacte al administrador del sistema."),
	TECHNICAL_ERROR_USER_NOT_FOUND("Error inesperado en UserFacadeImpl.findSpecificUser.",
			"Por favor verifique que la información proveniente de la base de datos sea correcta."),
	USER_ERROR_CONFIRM_MOBILE("Se presentó un problema inesperado al confirmar el número de celular del usuario.",
			"Por favor intente de nuevo y si el problema persiste contacte al administrador del sistema."),
	TECHNICAL_ERROR_CONFIRM_MOBILE("Error inesperado en UserFacadeImpl.confirmMobileNumber.",
			"Por favor verifique que la información proveniente de la base de datos sea correcta."),
	USER_ERROR_CONFIRM_EMAIL("Se presentó un problema inesperado al confirmar el correo electrónico del usuario.",
			"Por favor intente de nuevo y si el problema persiste contacte al administrador del sistema."), 
	TECHNICAL_ERROR_CONFIRM_EMAIL("Error inesperado en UserFacadeImpl.confirmEmail.",
			"Por favor verifique que la información proveniente de la base de datos sea correcta."), 
	USER_ERROR_SEND_MOBILE_CONFIRMATION("Se presentó un problema inesperado al enviar la confirmación del número de celular.",
			"Por favor intente de nuevo y si el problema persiste contacte al administrador del sistema."), 
	TECHNICAL_ERROR_SEND_MOBILE_CONFIRMATION("Error inesperado en UserFacadeImpl.sendMobileNumberConfirmation.",
			"Por favor verifique que la información proveniente de la base de datos sea correcta."), 
